...
function Home() {
  return (
    ...
    <div className='flex '>
        <div className='w-96 border-r-2 border-black-900 bg-white md:flex-row'>
            <div className='flex border-2 m-9 rounded-lg '>
                <div className='m-3'>
                    <img className='w-20' src="https://www.freeiconspng.com/thumbs/person-icon/clipart--person-icon--cliparts-15.png" alt="" />
                </div>
                <div className='m-3'>
            ...
            <div>
                <ul className='m-10'>
                    <li className='m-5 cursor-pointer text-xl'>
                        <i class="fa-solid fa-border-all"></i>
                        Overview </li>
                    <li  className='m-5 cursor-pointer text-xl bg-blue-700 rounded-lg p-3 text-white'>Store</li>
                    <li className='m-5 cursor-pointer text-xl'>User Account</li>
                    <li className='m-5 cursor-pointer text-xl'>Order</li>
                    <li className='m-5 cursor-pointer text-xl'>Contact & Support</li>
                    <li className='m-5 cursor-pointer text-xl'>Term & Condition</li>
                </ul>
            </div>
        ...
        <div className='bg-slate-100 flex justify-between'>
            <div className='mt-40 ml-20'>
                <ul className='cursor-pointer'>
                    <li className='m-3 bg-blue-300 p-2 rounded-lg'>Product</li>
